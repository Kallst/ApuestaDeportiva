...
<div class="success">¡Tu apuesta fue ganadora!</div>
</div>
...
<p class="highlight">Ganancia obtenida: ${{ $apuesta->ganancia }}</p>

</div>

<div class="footer">
Tu ganancia ya fue añadida a tu saldo. ¡Sigue apostando con nosotros!
</div>
